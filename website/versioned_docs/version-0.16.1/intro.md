...
title: Introduction
slug: /
description: "agnix validates AI agent configuration files across Claude Code, Cursor, Copilot, MCP, and AGENTS.md. 342 rules, auto-fix, and editor integration."
---
...
- **Validates** configuration files against 342 rules derived from official specs and real-world testing
...
- [Rules Reference](./rules/index.md) - browse all 342 validation rules
