...
└── zed/            # Zed extension
knowledge-base/     # 267 rules, 75+ sources, rules.json
...
- `rules/` - Validators implementing Validator trait (28 validators)
...
267 rules defined in `knowledge-base/rules.json` (source of truth)
...
- v0.14.0 - Production-ready with full validation pipeline
- 267 validation rules across 28 validators
