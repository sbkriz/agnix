...
└── zed/            # Zed extension
knowledge-base/     # 304 rules, 75+ sources, rules.json
...
304 rules defined in `knowledge-base/rules.json` (source of truth)
...
- v0.15.0 - Production-ready with full validation pipeline
- 304 validation rules across 28 validators
