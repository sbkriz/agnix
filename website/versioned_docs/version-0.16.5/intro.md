...
title: Introduction
slug: /
description: "agnix validates AI agent configuration files across Claude Code, Cursor, Copilot, MCP, and AGENTS.md. 230 rules, auto-fix, and editor integration."
---
...
- **Validates** configuration files against 230 rules derived from official specs and real-world testing
